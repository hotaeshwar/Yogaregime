export const classesData = [
  {
    ...
    benefits: [
      "Master biomechanical alignment and joint safety",
      "Develop stability, grounding, and muscular endurance",
      "Establish deep somatic awareness across all postures",
      "Cultivate calmness and balanced prana throughout the body"
    ],
  ...
  },
  {
    ...
    benefits: [
      "Builds immense core stability and upper-body power",
      "Develops unwavering concentration and internal discipline",
      "Cleanses and detoxifies through internal tapas (yogic heat)",
      "Deepens mind-body connection through moving meditation"
    ],
  ...
  },
  {
    ...
    benefits: [
      "Enhances cardiovascular endurance and rhythmic breath",
      "Releases stagnant tension and mental sluggishness",
      "Builds full-body functional flexibility and grace",
      "Fosters a luminous, uplifted state of flow"
    ],
  ...
  },
  {
    ...
    benefits: [
      "Regulates autonomic nervous system and relieves stress",
      "Increases lung capacity and oxygen utilization",
      "Calms mental turbulence and sharpens focus",
      "Prepares the mind naturally for profound meditation"
    ],
    schedule: "Daily Morning · 6:00 AM & 8:00 AM",
    featured: true
  },
  {
    id: "bandha-integration",
    title: "Bandha Integration",
    slug: "bandha-integration",
    ...
    benefits: [
      "Protects the lumbar spine and pelvic floor during deep postures",
      "Transforms physical weight into effortless lightness and buoyancy",
      "Channels pranic energy along the central channel (Sushumna)",
      "Unlocks core control and effortless inverted transitions"
    ],
    schedule: "Specialized Workshops & Weekly Practice · Tue & Fri 7:00 PM",
    featured: true
  },
  {
    id: "mudra",
    ...
    benefits: [
      "Balances internal five elements (Pancha Tattvas)",
      "Enhances concentration and meditative depth",
      "Directs subtle energy currents toward higher consciousness",
      "Promotes deep emotional grounding and tranquil mind"
    ],
    schedule: "Integrated into Pranayama & Meditation Circles",
    featured: false
  },
  {
    id: "meditation",
    ...
    benefits: [
      "Quiets cognitive fatigue and chronic overthinking",
      "Enhances emotional balance, equanimity, and presence",
      "Improves sleep quality and deep restorative recovery",
      "Fosters unconditional self-compassion and inner stillness"
    ],
    schedule: "Daily Evening · 8:00 PM",
    featured: true
  },
  {
    id: "shatkarma",
    ...
    benefits: [
      "Purifies respiratory passages and improves airflow",
      "Balances metabolic fire and digestive strength",
      "Enhances clarity of vision and mental sharpness through Trataka",
      "Prepares the physical body safely for advanced Pranayama"
    ],
    schedule: "Weekend Intensives & Personalized Guidance",
    featured: false
  },
  {
    id: "prenatal-yoga",
    ...
    benefits: [
      "Relieves spinal compression, hip tightness, and fatigue",
      "Strengthens pelvic floor safely and sustainably",
      "Cultivates soothing breath rhythms for deep maternal peace",
      "Supportive, conscious community for expectant and new mothers"
    ],
    schedule: "Sat & Sun · 9:30 AM",
    featured: false
  },
  {
    id: "advanced-asana",
    ...
    benefits: [
      "Refines complex biomechanics, leverage, and center of gravity",
      "Overcomes fear and psychological limitations on the mat",
      "Integrates Bandhas to achieve effortless suspension",
      "Deepens humility and ego-transcendence through challenging practice"
    ],
    schedule: "Sat & Sun · 7:30 AM",
    featured: true
  }
];
